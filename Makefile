...
# REMEMBER TO ADD ADITIONAL LIBARIES : https://github.com/esp8266/esp8266-wiki/wiki/Toolchain 
SDK_BASE	?= /opt/Espressif/esp_iot_sdk_v1.2.0
...
LIBS		= c gcc hal pp phy net80211 lwip wpa main upgrade
