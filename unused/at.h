...
//
//
//#define tcp_execTaskPrio        at_procTaskPrio
//#define tcp_execTaskQueueLen    at_procTaskQueueLen
//
//#define user_recvTaskPrio        at_recvTaskPrio
//#define user_recvTaskQueueLen    at_recvTaskQueueLen
...
typedef enum {
	at_statIdle, at_statRecving, at_statProcess, at_statIpSending, at_statIpSended, at_statIpTraning
} at_stateType;
